...
void flipper_ecu_scene_config_tps_on_enter(void* context) {
...
bool flipper_ecu_scene_config_tps_on_event(void* context, SceneManagerEvent event) {
    FlipperECUGui* app = context;
...
void flipper_ecu_scene_config_tps_on_exit(void* context) {
    FlipperECUGui* app = context;
